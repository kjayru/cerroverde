...
<section>
    ...
    <!-- CONTENT -->     
				   ...
				   <?php  
					...
					?>
				            ...
				            <div class="slide" data-mightyslider="cover:'<?php echo $imgsli['url'];?>'">
				              ...
				              <h4 class="inter"><?php echo $bl['descripcion'];?></h4>
			...
			<div class="cheron">
                ...
                <div class="col-md-12 acercade" id="istack1">
                    <?php echo get_field('contenido_arequipa',$post->ID); ?>
                    <img src="<?php echo $img['url']; ?>" alt="represa de bambuñeque" class="img-responsive center-block">
                </div>
                
                <div class="col-md-12 listas">
                	<?php the_content(); ?>
                </div>
 ...
 <div class="especificado col-md-12 ">
