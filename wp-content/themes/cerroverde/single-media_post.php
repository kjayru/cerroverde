...
<li><span class="separator">/</span><a title="Noticias" href="<?php echo $url; ?>"><?php echo $path; ?></a><span class="separator">/</span></li>
	...
	<div class="container singlemedia media-post">
    	
		<div class="row">
	   
			    <div class="col-lg-11 col-sm-11 col-md-11 col-xs-12 posteo prb">
            	
                <h1><?php  single_post_title(); ?></h1>
                <h4>Fuente: <?php echo get_field("fuente",$post->ID); ?></h4>
                <?php $img =  get_field("banner",$post->ID); ?>
                <div class="banner">
                	<img src="<?php echo $img['url']; ?>" alt="<?php echo get_field("texto_imagen",$post->ID); ?>" class="center-block img-responsive" >
                    <div class="caption">
                      <p><?php echo get_field("texto_imagen",$post->ID); ?></p>
                    </div>
				</div>
                ...
                <div class="intermedio hidden-sm hidden-md hidden-lg">
                  <!-- block only mobile -->
                  <div id="share-options" class="social-share">
                    <div class="inside">
                      <ul>
                        <li class="fb-share">
