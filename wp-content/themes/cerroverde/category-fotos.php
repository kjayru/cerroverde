               ...
               <?php  
				   foreach($prensas as $prensa):
					...
					$video  = get_field('video',$prensa->ID);
					   $descripcion  = get_field('descripcion',$prensa->ID);
					 ...
					 <div class="col-md-4" data-fecha="<?php echo date('F Y', strtotime($prensa->post_date)); ?>">
							<a href="#" class="mediafoto" data-dato="<?php echo $imagen['url'] ?>"  data-toggle="modal" data-target="#fotomodal" data-uri="<?php echo get_permalink($prensa->ID); ?>">
                            <figure>
              ...
              foreach($prensas as $prensa2): 
               ...
               <?php  
				   foreach($prensas as $prensa):
					...
					$fuente = get_field('fuente',$prensa->ID);
					$video  = get_field('video',$prensa->ID);
					   $descripcion  = get_field('contenido',$descripcion->ID);
